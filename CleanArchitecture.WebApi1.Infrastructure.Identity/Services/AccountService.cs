...
namespace CleanArchitecture.WebApi1.Infrastructure.Identity.Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(UserManager<ApplicationUser> userManager,
            ...
            SignInManager<ApplicationUser> signInManager, IUserClaimsPrincipalFactory<ApplicationUser> claimsPrincipalFactory, IAuthorizationService authorizationService,
        ...
        public async Task<(Response<bool> Result, string UserId)> CreateUserAsync(string userName, string password)
        {
            var user = new ApplicationUser
            {
                UserName = userName,
            ...
            return (new Response<bool>(result.Succeeded), user.Id);
        }
        ...
        public async Task<Response<bool>> DeleteUserAsync(string userId)
        {
            ...
            return user != null ? await DeleteUserAsync(user) : new Response<bool>(false,"user does not exist..invalid user");
        }
